...
#include "MongoCrash/Public/MyActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MONGOCRASH_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
	MONGOCRASH_API UClass* Z_Construct_UClass_AMyActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_MongoCrash();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyActor_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_MongoCrash,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyActor, 4174434707);
	template<> MONGOCRASH_API UClass* StaticClass<AMyActor>()
	{
		return AMyActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/MongoCrash"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
